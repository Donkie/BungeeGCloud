...
public class MCQuery {
    ...
    public QueryResponse fullStat() throws IOException {
        ...
        // int numPlayers = basicResp.onlinePlayers; //TODO use to determine max length
        // of full stat
    ...
    private int generateSessionID() {
        /*
         * Can be anything, so we'll just use 1 for now. Apparently it can be omitted
         * altogether. TODO: increment each time, or use a random int
         */
        return 1;
    }
